...
import numpy as np
from snuddd.efficiencies import Efficiency, efficiency_lz_nr, efficiency_lz_er, efficiency_xnt_nr, efficiency_xnt_er
from snuddd.quenching import Quenching, quenching_xe, quenching_electron
